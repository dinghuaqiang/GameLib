...
using GameLib.Core.Utils.Encryption;
#endif

using GameLib.Core.Utils.Core;
using GameLib.Core.Utils.Checksums;
using GameLib.Core.Utils.Compression.Streams;
using GameLib.Core.Utils.Compression;
...
namespace GameLib.Core.Utils 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="GameLib.Core.Utils.ZipException">
