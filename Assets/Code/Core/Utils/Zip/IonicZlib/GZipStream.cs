...
namespace GameLib.Core.Utils.IonicZlib
{
    /// <summary>
    ...
    ///   <c>GameLib.Core.Utils.IonicZlib.GZipStream</c> can compress while writing, or decompress while
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        ///     {
        ///         using (Stream decompressor= new GameLib.Core.Utils.IonicZlib.GZipStream(input, CompressionMode.Decompress, true))
        ///         {
        ...
        ///         Using decompressor As Stream = new GameLib.Core.Utils.IonicZlib.GZipStream(input, CompressionMode.Decompress, True)
        ...
        public override long Position
        {
            get
            {
                if (this._baseStream._streamMode == GameLib.Core.Utils.IonicZlib.ZlibBaseStream.StreamMode.Writer)
                    return this._baseStream._z.TotalBytesOut + _headerByteCount;
                if (this._baseStream._streamMode == GameLib.Core.Utils.IonicZlib.ZlibBaseStream.StreamMode.Reader)
        ...
        {
            if (_disposed) throw new ObjectDisposedException("GZipStream");
            if (_baseStream._streamMode == GameLib.Core.Utils.IonicZlib.ZlibBaseStream.StreamMode.Undefined)
            {
